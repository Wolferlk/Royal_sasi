...
const MarkAttendance = () => {
  ...
  // Fetch classes
  useEffect(() => {
    axios.get('http://localhost:5555/classes')
      .then(response => {
  ...
  return (
    <div className='Attendanceform'>
      <div>
        <label className='text-2xl' htmlFor="classSelect">Select Class:</label>
      ...
      <div>
        <label className='text-2xl' htmlFor="searchInput">Search Student:</label>
          ...
          <table className='w-100 border-separate border-spacing-2'>
            <thead>
              <tr>
                ...
                <th scope="col" className='border border-slate-600 rounded-md text-center'>Mark</th>
              </tr>
            </thead>
            <tbody>
